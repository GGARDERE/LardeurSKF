...
public class PremierTest extends AbstractTest{
	...
	String recherche1= "Lardeur";
		...
		List<String> listeRefObjet1 = pageEquipement.loadFile("filesRessources/item1");
		...
		List<String> listeRefObjet2 = pageEquipement.loadFile("filesRessources/item2");
		...
		List<String> listeRefObjet3 = pageEquipement.loadFile("filesRessources/item3");
		...
		List<String> listeRefObjet4 = pageEquipement.loadFile("filesRessources/item4");
		...
		List<String> listeRefObjet5 = pageEquipement.loadFile("filesRessources/item5");
